...
Este projeto foi criado como uma demonstração das capacidades do React e Tailwind CSS para uma página de produto de ecommerce. Tratamos aqui apenas de funcionalidades, sem praticar tanto o frontend. Projeto realizado dentro do curto prazo estimado para a atividade em questão.
